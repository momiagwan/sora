      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {blogs.length > 0 ? (
            blogs.map((b) => (
              ...
              >
                <div>
                  ...
                  <p className="text-gray-200 text-base leading-relaxed font-serif transition-all duration-300">
                    {expanded[b._id]
                      ? b.content
            ...
            <div className="col-span-3 text-center text-indigo-400 text-lg">
              No blogs available.
            </div>
          )}
        </div>
